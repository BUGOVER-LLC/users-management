...
namespace App\Core\Enum\Concerns;
...
trait EnumConcern
{
    ...
    {
        return static::all($method)->contains($value);
    }
    ...
    {
        return static::all()->hasAny($cases);
    }
    ...
    {
        return static::all($method)->search($case);
    }
    ...
    {
        return static::all($method)->toJson($options);
    }
    ...
    {
        return static::all($method)->toArray();
    }
    ...
    {
        return static::all($method)->random();
    }
    ...
    {
        return static::caseByValue(static::all()->random());
    }
    ...
    {
        return static::casesCollection()->toArray();
    }
    ...
    {
        return static::all($method)->only($cases);
    }
    ...
    {
        return static::only($cases, $method)->toArray();
    }
    ...
    {
        return static::all($method)->except($cases);
    }
    ...
    {
        return static::all($method)->first();
    }
